  ...
  <div class="container-fluid h-custom">
    <div class="row d-flex justify-content-center align-items-center h-100">
      ...
      <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
        <form action="<?php echo site_url('Login/validasi') ?>" method="post"><br><br><br><br>
        <?php $pesan = $this->session->flashdata('pesan');?>
        <?php if (isset($pesan)):?>
         <div class="alert-danger text-center">
            <strong>Login Gagal!</strong><br> 
            <a> Username atau Password Anda tidak Terisi atau Salah!.</a>
         </div>
        <?php endif?>
          ...
          <div class="text-center text-lg-start mt-4 pt-2">
            ...
            <p class="small fw-bold mt-2 pt-1 mb-0">Belum punya akun? Daftar disini.<a href="<?php echo site_url('Login/register') ?>"
