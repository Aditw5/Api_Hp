                                ...
                                <form class="form-horizontal form-material "  action="<?php echo $action; ?>" method="post">
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input name="nama_lengkap" id="nama_lengkap" value="<?php echo $nama_lengkap; ?>"
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="password" id="password"  value="<?php echo $password; ?>" class="form-control p-0 border-0">
                                        </div>
                                    </div>
                                    <!-- <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Hak Akses</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="hak_akses" placeholder="123 456 7890"
                                                class="form-control p-0 border-0">
                                        </div>
                                    </div> -->
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-sm-12 border-bottom">
                                            <select name="hak_akses" id="hak_akses" class="form-select shadow-none p-0 border-0 form-control-line">
                                                <option value="A" >Admin</option>
                                                <option value="P" >Pengunjung</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
