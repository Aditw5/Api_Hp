        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Akun</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li><a href="<?php echo site_url('Login/register') ?>">Daftar</a></li>
            </ul>
          </li>
          <!-- <li><a class="getstarted scrollto" href="<?php echo site_url()?>/Login">Akun</a></li> -->
        </ul>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1>ApiHP menyediakan RESTful API (Application Programming Interface)
            </h1>
          <h2> </h2>
          <div class="d-flex">
          </div>
