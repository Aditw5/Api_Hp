        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">List Key</h4>
                    </div>
            ...
            foreach ($user_data as $user)
            {
                ...
                <td style="text-align:center" width="200px">
                    ...
                    echo anchor(site_url('Key/delete/'.$user->id),'<i class="fa fa-trash"></i>', 'class="btn btn-xs btn-danger"  data-toggle="tooltip" title="Delete"','onclick="javasciprt: return confirm(\'Apakah Anda Yakin ?\')"'); 
                    ?>
                </td>
                                        </tr>
                                        <?php
