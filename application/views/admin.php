...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <!-- ============================================================== -->
                        ...
                        <a class="logo-icon ">
                            <!-- Dark Logo icon -->
                            <!-- <img src="<?php echo base_url()?>assets/img/api.png"  width="50"    alt="homepage" /> -->
                        </a> 
                        <!-- <a class="page-title" > ApiHP     </a> -->
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span class="logo-text">
                           
                            <img src="<?php echo base_url()?>assetU/plugins/images/1.png" alt="homepage" />
                        </span>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo site_url()?>/Admin"
                                aria-expanded="false">
                        ...
                        <!-- <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo site_url()?>/Data"
                                aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo site_url()?>/Api"
                                aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo site_url()?>/KHp"
                                aria-expanded="false">
                                <i class="fa fa-phone" aria-hidden="true"></i>
                                <span class="hide-menu">Kelola HP</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo site_url()?>/Key"
                                aria-expanded="false">
                                <i class="fa fa-key" aria-hidden="true"></i>
                                <span class="hide-menu">Kelola Keys</span>
                            </a>
                        </li>
                        <!-- <li class="sidebar-item">
        ...
        <?php $this->load->view($page);?>
            ...
            <!-- footer -->
            <!-- ============================================================== -->
            <footer class="footer text-center"> 2023 © Adit brought to you by <a
                    href="https://adit.d3mi2020.com">adit.d3mi2020.com</a>
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
